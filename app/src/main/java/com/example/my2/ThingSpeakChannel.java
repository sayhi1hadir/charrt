...
public class ThingSpeakChannel  {
    ...
    public void loadChannelFieldFeed(int fieldId) {
...
//                }
    ...
    /***
     * Set the {@link com.example.my2.ThingSpeakChannel.ChannelFeedUpdateListener} to use.
     *
    ...
    /***
     * Set the {@link com.example.my2.ThingSpeakChannel.FeedEntryUpdateListener} to use.
     *
     * @param listener The listener.
     */
    ...
    /***
     * Set the {@link com.example.my2.ThingSpeakChannel.ChannelFieldFeedUpdateListener} to use.
     *
     * @param listener The listener.
     */
    ...
    /***
     * Set the {@link com.example.my2.ThingSpeakChannel.ChannelStatusUpdateListener} to use.
     *
     * @param listener The listener.
     */
    ...
    public void loadChannelFeed() {
        mService.getChannelFeed(mChannelId, getChannelRequestParams(), new Callback<ChannelFeed>() {
            @Override
            public void onResponse(@NonNull Call<ChannelFeed> channelFeed, Response<ChannelFeed> response) {
...
//                }
            ...
            @Override
            public void onFailure(@NonNull Call<ChannelFeed> call, Throwable t) {
...
//            }
    ...
    public void loadSpecificEntryInChannelFeed(final long entryId) {
        mService.getSpecificEntryInChannelFeed(mChannelId, entryId, getEntryRequestParams(), new Callback<Feed>() {
            ...
            @Override
            public void onResponse(Call<Feed> feed, Response<Feed> response) {
                if (mFeedUpdateListener != null) {
                    mFeedUpdateListener.onFeedUpdated(mChannelId, entryId, (Feed) feed);
...
//            @Override
//            public void onResponse(Call<StatusUpdates> call, Response<StatusUpdates> response) {
//
//            }
//
//            @Override
//            public void onFailure(Call<StatusUpdates> call, Throwable t) {
//
//            }
//
//            @Override
